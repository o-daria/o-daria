...
- **Application code location**: `o_daria_ui/` (NEVER aidlc-docs/)
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/types.ts`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/tokenStorage.ts`
**Changes**:
...
**Action**: CREATE `o_daria_ui/packages/@app/auth/src/googleAuthService.ts`
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/AuthService.ts`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/AuthContext.tsx`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/AuthProvider.tsx`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/packages/@app/auth/src/index.ts`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/apps/mfe-auth/package.json`
...
**Action**: MODIFY `o_daria_ui/apps/mfe-auth/webpack.config.js`
...
**Action**: MODIFY `o_daria_ui/apps/shell/webpack.config.js`
**Change**: Add `'process.env.GOOGLE_CLIENT_ID': JSON.stringify(process.env.GOOGLE_CLIENT_ID ?? '')` to `DefinePlugin`
**Traceability**: SEC-FE-03, COMPAT-FE-03

### Step 11: `LoginPage.tsx` — replace Formik form with `<GoogleLogin>` [x]
**Action**: MODIFY `o_daria_ui/apps/mfe-auth/src/pages/LoginPage.tsx`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/apps/mfe-auth/src/Module.tsx`
**Changes**:
...
**Action**: MODIFY `o_daria_ui/apps/shell/src/App.tsx`
**Changes**:
- Import `{ GoogleOAuthProvider }` from `@react-oauth/google`
- Wrap `InnerApp` in `<GoogleOAuthProvider clientId={process.env.GOOGLE_CLIENT_ID ?? ''}>`
**Traceability**: BR-FE-AUTH-08, SEC-FE-03

### Step 14: `o_daria_ui/.env.example` — add `GOOGLE_CLIENT_ID` [x]
**Action**: MODIFY `o_daria_ui/.env.example`
